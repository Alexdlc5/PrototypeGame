    ...
    void Update()
    {
       ...
       // {
            ...
            if (playerrot.eulerAngles.z <= 180 && playerrot.eulerAngles.z >= 0 && playerrot.eulerAngles.x <= 180 && playerrot.eulerAngles.x >= 0)
            {
                ...
                transform.localPosition = new Vector3(3, avgrot / 15 + 2, -7.15f + avgrot / 8);
            ...
            {
                //changes position and rotation of camera in relation to the player to avoid clipping the ground
                transform.localPosition = new Vector3(3, avgrotz / 15 + 2, -7.15f + avgrotz / 8);
            ...
            {
                //changes position and rotation of camera in relation to the player to avoid clipping the ground
                transform.localPosition = new Vector3(3, avgrotx / 15 + 2, -7.15f + avgrotx / 8);
            ...
            {
                //changes position and rotation of camera in relation to the player to avoid clipping the ground
                transform.localPosition = new Vector3(3, (360 - avgrot) / 15 + 2, -7.15f + (360 - avgrot) / 8);
